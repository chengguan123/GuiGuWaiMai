<template>
  <div class="shop-header">
    <nav class="shop-nav"
      ...
      <a class="back" @click="$router.push({path:'/msite'})">
        <img src="./images/后退.png" style="z-index: 3;width: 2rem;margin-left: 5px">
      </a>
    </nav>
    <div class="shop-content" @click="toggleShow">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="toggleSupportShow">
      <div class="discounts-left">
        <div class="activity" :calss="supportClasses[info.supports[0].type]">
          <span class="content-tag">
      ...
      <div class="shop-brief-modal" v-show="shopShow">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer"  @click="toggleShow">
            <img src="./images/关闭.png" style="width: 1rem;">
          </div>
        </div>
